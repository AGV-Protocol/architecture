          ...
          <div className="text-center mb-12 max-w-5xl mx-auto">
            ...
            <div className="mb-6 sm:mb-8 flex items-center justify-center gap-4 sm:gap-6 md:gap-8 px-2">
              ...
              <div className="shrink-0">
                <img src="/pregvt_icon.png" alt="PreGVT" className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32" />
              </div>
              ...
              {/* GVT Icon */}
              <div className="shrink-0">
                <img src="/gvt_icon.png" alt="GVT" className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32" />
              </div>
            </div>
